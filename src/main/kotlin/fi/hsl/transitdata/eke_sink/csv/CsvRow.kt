...
data class CsvRow(
    val messageType: Int,
    val ntpTime: ZonedDateTime?,
    val ntpOk: Boolean?,
    val ekeTime: ZonedDateTime?,
    val mqttTime: ZonedDateTime,
    ...
    companion object {
        ...
        fun create(
            mqttTopic: String,
            mqttTime: ZonedDateTime,
            mqttHeader: MqttHeader,
            rawData: String
        ): CsvRow =
            CsvRow(
                mqttHeader.messageType,
        ...
        fun create(
            ...
            CsvRow(
                ConnectionStatus.CONNECTION_STATUS_MESSAGE_TYPE,
                null,
                null,
