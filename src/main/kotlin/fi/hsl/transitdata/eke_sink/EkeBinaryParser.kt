...
object EkeBinaryParser {
    ...
    val BRAKE_CYLINDER_PRESSURE_AT_AXLE = FieldDefinition(BRAKE_CYLINDER_PRESSURE_AT_AXLE_OFFSET, BRAKE_CYLINDER_PRESSURE_AT_AXLE_SIZE, TO_UNSIGNED_INT_ARRAY, "breakCylinderPressureAtAxle")
    ...
    val CATENARY_VOLTAGE = FieldDefinition(CATENARY_VOLTAGE_OFFSET, CATENARY_VOLTAGE_SIZE, TO_UNSIGNED_INT,"catenaryVoltage")
    ...
    val OUTSIDE_TEMP = FieldDefinition(OUTSIDE_TEMP_OFFSET, OUTSIDE_TEMP_SIZE, TO_INT,"outsideTemp")
    ...
    val GPSX = FieldDefinition(GPSX_OFFSET, GPSX_SIZE, TO_FLOAT,"GPSX")
    val GPSY = FieldDefinition(GPSY_OFFSET, GPSY_SIZE, TO_FLOAT,"GPSY")
    val TIME = FieldDefinition(TIME_OFFSET, TIME_SIZE, TO_DATE,"GPSTime")
